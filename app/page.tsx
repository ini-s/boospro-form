...
export default function Home() {
  ...
  return (
    <>
      <ShowView when={!successful}>
        <div className="relative w-screen">
          <div className="px-6 md:flex md:px-0 md:h-screen">
            ...
            >
              <div className="relative w-14 h-[60px] xl:w-16 xl:h-[70px] mx-auto mb-7">
                <Image src="/bootspro-logo.png" alt="logo" sizes="100%" fill />
              </div>
              ...
              <ShowView when={active === "workers"}>
                ...
                <div className="mt-7 xl:mt-8 text-left flex flex-col ">
                  ...
                  <input
                    ...
                    className="border-app-black-800 border rounded-10 outline-app-black-800 h-10 indent-4"
                    {...register("workers", {
                      required: "Please enter the total number of workers",
                    })}
                  />
                  {errors.workers && (
                    <p className="text-red-500 text-sm">
              ...
              <ShowView when={active === "workers"}>
                <button className="mt-7 font-medium text-white bg-[#28323E] rounded-30 w-full py-2.5 pointer">
                  Continue
                </button>
              </ShowView>
          ...
          <div className="absolute w-14 h-14 bottom-[2rem] right-5 pointer s:right-8 md:left-6 md:h-[70px] md:w-[70px]">
            <Image src="/chat-icon.png" alt="chat-icon" sizes="100%" fill />
          </div>
      ...
      <ShowView when={successful}>
        <div className="relative w-screen bg-[#EBF6FF] h-screen">
          <div className="relative mx-auto max-w-[500px] h-full">
            <Success />

            <div className="absolute w-[200px] h-[218px] bottom-[26%] left-[-4.5rem] md:left-[-4rem] z-1">
              <Image src="/success-bg.png" alt="success-bg" sizes="100%" fill />
            </div>
          </div>
        </div>
      </ShowView>
